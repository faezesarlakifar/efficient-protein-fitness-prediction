...
For now, I don’t run all 217 assays. I picked a stratified subset (6 assays) covering short (<200 aa), medium (200–500 aa), and long (>500 aa) proteins, so the cost/accuracy trade-off can be analyzed as a function of sequence length, not just in aggregate.
